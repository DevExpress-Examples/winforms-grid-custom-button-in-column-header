Namespace DXSample
	Partial Public Class Main
		...
		Private Sub InitializeComponent()
			...
			Me.gridControl1.Size = New System.Drawing.Size(467, 445)
			Me.gridControl1.TabIndex = 0
			Me.gridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() { Me.gridView1})
			' 
			' gridView1
			' 
			Me.gridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() { Me.colCustomerID, Me.colFirstName, Me.colLastName})
			...
			Me.ClientSize = New System.Drawing.Size(467, 445)
			Me.Controls.Add(Me.gridControl1)
			Me.Name = "Main"
			Me.Text = "How to add a custom button to a column header"
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.Load += new System.EventHandler(this.OnFormLoad);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.OnFormClosing);
